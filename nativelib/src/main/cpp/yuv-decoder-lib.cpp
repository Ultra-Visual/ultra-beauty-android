...
//
// Created by T-Oner on 2022/6/28.
//

extern "C"
JNIEXPORT void JNICALL
Java_com_uvisual_beauty_nativelib_YuvDecoder_yuvToRgba(JNIEnv *env, jobject thiz,
                                                       jbyteArray yuv420sp,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_uvisual_beauty_nativelib_YuvDecoder_yuvToArgb(JNIEnv *env, jobject thiz,
                                                       jbyteArray yuv420sp,
                                                       jint width, jint height, jintArray rgbOut) {
    int sz;
    int i;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_uvisual_beauty_nativelib_YuvDecoder_adjustBitmap(JNIEnv *jenv, jobject thiz,
                                                          jobject src) {
